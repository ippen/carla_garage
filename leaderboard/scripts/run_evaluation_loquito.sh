#!/bin/bash
# Must set CARLA_ROOT
export LOQUITO_RECORDING_DIR=/home/ippen/workspace/data/recordings_l6
export LOQUITO_LIVE_RESULTS=1

export WORK_DIR=/home/ippen/workspace/projects/end2end-driving-model/loquito/eval/closed_loop/carla_garage
...
# TCP evaluation
export ROUTES=/home/ippen/workspace/projects/carla_garage/leaderboard/data/longest6.xml
...
export TEAM_CONFIG=""
export CHECKPOINT_ENDPOINT=results_l6.json
export SAVE_PATH=/home/ippen/workspace/data/recordings_l6/save
